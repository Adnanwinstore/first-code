                ...
                <div className="container border-top">
                    ...
                    {/* Shop Page Side Bar  */}
                        <div className="col-md-3 bg-white px-3 mt-5 py-2">
                            ...
                            <hr />
                            <h4 className="pt-2 font-weight-bold text-muted disabled border-bottom pb-2">Pharmacy <span className="float-right text-muted"> <i class="fa fa-angle-double-down floating" aria-hidden="true"></i></span></h4>
